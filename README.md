...
- **Název, autor, rok, vydavatel, místo vydání, poznámka** — dají se upravit
  ještě před uložením; to se hodí hlavně u knih, které databáze neznají, a u míst
  vydání, která zdroje často neuvádějí vůbec.
